...
namespace SistemaInmueble.DAL.Implementacion
{
    public class VentaRepository : GenericRepository<Venta>, IVentaRepository
    {
        ...
        public VentaRepository(DBINMUEBLEContext dbContext) : base(dbContext)
        {
        ...
        public async Task<Venta> Registrar(Venta entidad)
        {
            ...
            using (var transaction = _dbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    {
                        Proyecto proyecto_encontrado = _dbContext.Proyectos.Where(p => p.IdProducto == dv.IdProducto).First();
                        proyecto_encontrado.Stock = proyecto_encontrado.Stock - dv.Cantidad;
                        _dbContext.Proyectos.Update(proyecto_encontrado);
                    }
